...
function LoginContent() {
  ...
  return (
    <div className="flex flex-1 items-center justify-center px-4 py-20">
      ...
      >
        <h1 className="mb-6 text-2xl font-bold text-[var(--text-primary)]">{t("loginTitle")}</h1>
        {error && (
        ...
        <button
          ...
          className="spring-transition mb-4 flex w-full items-center justify-center gap-3 rounded-2xl border border-[var(--border-subtle)] bg-white px-4 py-3 font-medium text-gray-700 hover:bg-gray-50 hover:shadow-md dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
        >
        ...
        <div className="mb-4 flex items-center gap-3">
          ...
          <span className="text-xs text-[var(--text-muted)]">{tc("or")}</span>
          <div className="h-px flex-1 bg-[var(--border-subtle)]" />
        </div>
